...
class ForecastingService:
    ...
    def forecast(self, model, periods: int = 30) -> pd.DataFrame:
        # Generate forecasts
    ...
    def serialize_to_s3(self, model, key: str):
    ...
    def auto_forecast(self, data: pd.DataFrame, config: ForecastConfig, periods: int = 30):
