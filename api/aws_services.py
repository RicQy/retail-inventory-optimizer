...
class AWSServiceManager:
    ...
    async def create_job_metadata(self, job_metadata: JobMetadata) -> bool:
        ...
        try:
            ...
            self.dynamodb_client.put_item(TableName=self.jobs_table_name, Item=item)
    ...
    async def get_job_metadata(self, job_id: str) -> Optional[JobMetadata]:
        ...
        try:
            response = self.dynamodb_client.get_item(
                TableName=self.jobs_table_name, Key={"job_id": {"S": job_id}}
            )
    ...
    async def update_job_metadata(self, job_id: str, updates: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            expression_attribute_values[":updated_at"] = {
    ...
    async def list_jobs(
        ...
        try:
            ...
            scan_params = {"TableName": self.jobs_table_name, "Limit": limit}
    ...
    async def enqueue_job(
        self, job_metadata: JobMetadata, delay_seconds: int = 0
    ) -> bool:
        ...
        try:
            ...
            logger.info(
                f"Enqueued job: {job_metadata.job_id}, Message ID: {response['MessageId']}"
            )
            return True
    ...
    async def invoke_lambda_function(
        self, function_name: str, payload: Dict[str, Any], asynchronous: bool = True
