...
def create_er_diagram():
    ...
    ax.text(
        5,
        7.5,
        "Retail Sales Dataset - Entity Relationship Diagram",
        fontsize=16,
        fontweight="bold",
        ha="center",
    )
    ...
    entity_rect = patches.Rectangle(
        (2, 2), 6, 4, linewidth=2, edgecolor="black", facecolor="lightblue", alpha=0.7
    )
    ...
    pk_fields = ["* store_id : VARCHAR(20)", "* sku : VARCHAR(50)", "* date : DATE"]
    ...
    ax.text(
        5,
        1.2,
        "INDEXES: store_id, sku, date, on_hand",
        fontsize=9,
        ha="center",
        style="italic",
    )
